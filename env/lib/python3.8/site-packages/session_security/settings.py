...
# time in seconds round to no decimal point
EXPIRE_AFTER_ = round(eval(config('SESSION_SECURITY_EXPIRE_AFTER')) * 60)
# time in seconds round to no decimal point
WARN_AFTER_ = round(eval(config('SESSION_SECURITY_WARN_AFTER')) * 60)

EXPIRE_AFTER = getattr(
    settings, 'SESSION_SECURITY_EXPIRE_AFTER', EXPIRE_AFTER_)

WARN_AFTER = getattr(settings, 'SESSION_SECURITY_WARN_AFTER', WARN_AFTER_)
